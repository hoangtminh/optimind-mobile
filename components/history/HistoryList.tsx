...
export const HistoryList: React.FC<HistoryListProps> = ({
  ...
  const renderEmptyComponent = () => {
    ...
    return (
      <View style={{ backgroundColor: Theme.surface, padding: 32, borderRadius: 12, borderWidth: 1, borderColor: Theme.border, alignItems: "center", justifyContent: "center", marginTop: 32, marginHorizontal: 24 }}>
        ...
        <Text style={{ fontSize: 13, color: Theme.textMuted, textAlign: "center", maxWidth: 240 }}>
          Start your first study session to track your cognitive metrics and progress!
        </Text>
      </View>
    );
  };
    ...
    >
      ...
      <SectionList
        ...
        renderSectionHeader={({ section: { title } }) => (
          <Text style={{ color: Theme.text, fontWeight: "700", fontSize: 12, letterSpacing: 0.5, marginTop: 16, marginBottom: 12, textTransform: "uppercase", paddingHorizontal: 28 }}>
            {title}
          </Text>
        )}
        ListHeaderComponent={
