    ...
    >
      <YStack flex={1}>
        ...
        >
          ...
          <TabButton
            backgroundColor={
              activeTab === "kanban" ? Theme.primaryPastel : "transparent"
            }
            onPress={() => setActiveTab("kanban")}
          >
            <Layout
              size={14}
              color={activeTab === "kanban" ? Theme.primary : Theme.textMuted}
            />
            <Text
              fontSize="$2"
              fontWeight="700"
          ...
          <TabButton
            backgroundColor={
              activeTab === "chat" ? Theme.primaryPastel : "transparent"
            }
          ...
          <TabButton
            backgroundColor={
              activeTab === "log" ? Theme.primaryPastel : "transparent"
            }
        ...
        {activeTab === "tasks" ? (
          <FlatList
            ...
            renderItem={({ item }) => {
              if (item.type === "header") {
                if (item.count === 0 && item.title === "Completed") return null;
                return (
                  <XStack
          ...
          >
            ...
            <Text
              ...
              marginTop="$2"
            >
              The {activeTab} feature is currently under development.
            </Text>
          </YStack>
        )}
